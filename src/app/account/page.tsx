...
import { ordersWithCustomerAccountsEnabled } from "@/lib/studio/draft-public";
...
export default async function CustomerAccountPage() {
  ...
  // Only websites whose owner enabled customer accounts may expose orders here.
  const orders = await ordersWithCustomerAccountsEnabled(
    await getOrdersStore().listForCustomer(session.account.id, 50),
  );
