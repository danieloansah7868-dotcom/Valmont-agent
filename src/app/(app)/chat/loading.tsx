export default function ChatLoading() {
  return (
    <div
      className="chat-shell fixed inset-x-0 top-20 bottom-16 flex overflow-hidden bg-navy md:left-[228px] md:bottom-0"
      role="status"
      aria-live="polite"
    >
      ...
      <aside className="hidden w-[280px] shrink-0 border-r border-ivory/10 bg-navy-900 lg:block">
        ...
        <div className="space-y-2 p-3">
          {Array.from({ length: 4 }).map((_, index) => (
            <div key={index} className="rounded-xl border border-ivory/10 p-3">
